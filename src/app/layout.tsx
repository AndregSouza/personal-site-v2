          ...
          <Sidebar animate={false}>
            <SidebarBody>
              <div className="flex h-14 items-center justify-between">
                ...
                <Link href="/" className="hidden md:flex flex items-center gap-2.5 pr-3 font-medium">
                  <Button size="icon" className="bg-sidebar-active hover:bg-sidebar-hover" aria-label="Fechar">
                    <svg width="20" height="20" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg" role="img">
