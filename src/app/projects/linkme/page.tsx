  ...
  return (
    <div className="w-full flex flex-col max-w-3xl p-6 gap-4 md:p-8 md:gap-6 lg:gap-8 lg:p-16 self-center">
      ...
      <article>
        ...
        <video src="../projects/linkme/Intro-Sales-1-transcode.webm" />
        ...
        <video src="../projects/linkme/Desktop-Linkme-1-transcode.webm" />
        ...
        <video src="../projects/linkme/Anticipation-1-transcode.webm"></video>
